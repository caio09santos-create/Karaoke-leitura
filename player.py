...
<script>
  ...
  elAtraso.addEventListener("change", () => {
...
def construir_player_sincronizado(
    ...
    `synced` é uma lista de (tempo_em_segundos, texto). Retorna HTML pronto para
    `st.components.v1.html`. Sem letra sincronizada, devolve um aviso inócuo.
    """
    if not synced:
